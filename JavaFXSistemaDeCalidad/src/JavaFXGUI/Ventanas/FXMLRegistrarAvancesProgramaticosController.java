...
public class FXMLRegistrarAvancesProgramaticosController implements Initializable {
    ...
    @FXML
    private TextArea taTemasDeUnidad;
    @FXML
    private TextField tfUnidad;
    @FXML
    private TextField tfFechaInicioFinDeUnidad;
    @FXML
    private TextField tfNombreDeAvance;
    @FXML
    private TextField tfFechaDeRegistro;
    @FXML
    ...
    @FXML
    private TableColumn<?, ?> tcTemasIUnidad;
    @FXML
    private TextField tfAvanceDeUnidad;
    @FXML
    private TextField tfAvance;
    @FXML
    private TextArea taObservaciones;
    @FXML
    private TableView<?> tvAvanceDeunidad;
    @FXML
    private TableColumn<?, ?> tcUnidadAvance;
    @FXML
    private TableColumn<?, ?> tcAvance;
    @FXML
